...
public class FileDetailEntity {
    ...
    public void update(Long fileId, String originFileName, String fileName, String ip,
                       String filePath, Integer fileSize, String ext, String url,
                       String sysCreateUser, String sysModifyUser) {
        this.fileId = fileId;
