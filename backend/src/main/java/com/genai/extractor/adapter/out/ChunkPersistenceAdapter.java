...
import com.genai.extractor.application.port.ChunkPersistencePort;
import com.genai.global.wrapper.PageWrapper;
import com.genai.extractor.domain.model.Chunk;
...
public class ChunkPersistenceAdapter implements ChunkPersistencePort {
    ...
    public PageWrapper<Chunk> getChunksPort(int page, int size, long passageId) {
        ...
        return PageWrapper.<Chunk>builder()
                .content(chunkEntities.stream().map(ChunkEntity::toDomain).toList())
