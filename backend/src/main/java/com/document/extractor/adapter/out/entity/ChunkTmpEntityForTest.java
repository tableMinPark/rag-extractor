...
@Entity
@Table(name = "WN_CHUNK_TMP")
@Comment("청크")
@EntityListeners(AuditingEntityListener.class)
public class ChunkTmpEntityForTest {
    ...
    public ChunkTmpEntityForTest update(Chunk chunk) {
    ...
    public static ChunkTmpEntityForTest fromDomain(Chunk chunk) {
        return ChunkTmpEntityForTest.builder()
