...
export default function RegisterPage() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden">
      ...
      >
        <div className="absolute top-[-80px] right-[-80px] w-72 h-72 rounded-full opacity-20" style={{ backgroundColor: '#fff' }} />
        <div className="absolute bottom-[-60px] left-[-60px] w-96 h-96 rounded-full opacity-10" style={{ backgroundColor: '#fff' }} />
        <div className="absolute bottom-40 right-16 w-32 h-32 rounded-full opacity-15" style={{ backgroundColor: '#fff' }} />
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-bold text-xl tracking-tight">RAG Extractor</span>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-8 bg-gray-50">
        <div className="w-full max-w-sm">
          <div className="lg:hidden flex items-center gap-2 mb-10">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#c64f4f' }}>
