...
@Entity
@Table(name = "WN_CHUNK_ORIGIN")
@Comment("청크")
@EntityListeners(AuditingEntityListener.class)
public class ChunkOriginEntityForTest {
    ...
    public ChunkOriginEntityForTest update(Chunk chunk) {
    ...
    public static ChunkOriginEntityForTest fromDomain(Chunk chunk) {
        return ChunkOriginEntityForTest.builder()
